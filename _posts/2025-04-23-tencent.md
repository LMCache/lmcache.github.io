...
thumbnail-img: https://github.com/user-attachments/assets/lmcache-tencent.jpg
share-img: https://github.com/user-attachments/assets/lmcache-tencent.jpg
author: LMCache Team and Tencent
image: https://github.com/user-attachments/assets/lmcache-tencent.jpg
---
<br>
...
- This work is a collaborative effort between engineers from **Tencent** and the **LMCache Team**. 

This article refers to LMCache based on commit-0213f83a7 LMCache V1(experimental), and introduces it in the context of the inference engine vLLM's V0 version.

<div align="center">
<img src="/assets/img/lmcache-tencent.jpg" alt="Icon" style="width: 67%; vertical-align:middle;">
...
In the remote backend diagram above, **MooncakeStore**, **Valkey**, and **DFS** are Tencent's contributions to LMCache. The **DOP KVStore** was not contributed as it is an internal Tencent product.
...
<p style="text-align: center;">Fig 3: LMCache Examples</p>
...
<p style="text-align: center;">Fig 4: Mooncake Store Architecture</p>
</div>
...
#### Create the `MooncakestoreConnector` Class

`MooncakestoreConnector` needs to extend the `RemoteConnector` class as a subclass and implement all its abstract methods.

<div align="center">
<img src="/assets/img/tencent_blog/mooncake_connector.png" alt="Icon" style="width: 67%; vertical-align:middle;">
<p style="text-align: center;">Fig 5: Mooncake Connector Demonstration</p>
</div>
...
*   Merged metadata and kvbytes to reduce the number of keys stored in the KV store and decrease request frequency.
